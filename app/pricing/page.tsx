...
export default function PricingPage() {
  ...
  const handleUpgrade = (planId: string) => {
    // TODO: Implémenter le processus de paiement (Stripe)
            ...
            <div className="max-w-4xl mx-auto mt-16 text-center">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-left">
                <div className="p-4 rounded-lg bg-card/50 border border-border">
                  <p className="font-medium text-foreground mb-1">Puis-je changer de plan ?</p>
                  <p className="text-sm text-muted-foreground">Oui, upgradez ou downgradez à tout moment.</p>
                </div>
                <div className="p-4 rounded-lg bg-card/50 border border-border">
                  <p className="font-medium text-foreground mb-1">Y a-t-il un engagement ?</p>
                  <p className="text-sm text-muted-foreground">Non, résiliez quand vous voulez.</p>
                </div>
                <div className="p-4 rounded-lg bg-card/50 border border-border">
                  <p className="font-medium text-foreground mb-1">Période d'essai ?</p>
                  <p className="text-sm text-muted-foreground">14 jours gratuits sur les plans Pro et Enterprise.</p>
                </div>
                <div className="p-4 rounded-lg bg-card/50 border border-border">
                  <p className="font-medium text-foreground mb-1">Modes de paiement ?</p>
                  <p className="text-sm text-muted-foreground">Carte bancaire, virement (Enterprise).</p>
                </div>
              </div>
            </div>
          </div>
